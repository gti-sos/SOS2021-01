...
(async () => {
 ...
 // await page.goto('http://localhost:10000/', { waitUntil: 'networkidle2' });
  ...
  await page.click(" body > main > main > div:nth-child(5) > div > div:nth-child(2) > div > div.card-body > a:nth-child(5) > button"); //cargando life-stats
  ...
  await page.waitForTimeout(10000);
  await page.screenshot({ path: screenshotPath + (counter++) +'_INTEGRATIONS_LIFE_SPACE.png' });
  await page.click("body > main > main > ul > li:nth-child(2) > a");
  ...
  await page.waitForTimeout(10000);
  await page.screenshot({ path: screenshotPath + (counter++) +'_INTEGRATIONS_LIFE_FIRE.png' });
  await page.click("body > main > main > ul > li:nth-child(2) > a");

  await page.click("body > main > main > div:nth-child(4) > div > div.card-body > a:nth-child(8) > button");
  await page.waitForTimeout(10000);
  ...
  await page.click("body > main > main > ul > li:nth-child(1) > a"), //borrando life-stats
  ...
  console.log("--Life press analytics type line again => analytics 1 view again--");
  await page.click("body > main > main > div.nav.svelte-1xdzfq5 > ul > li:nth-child(2) > a"); //entramos de nuevo
  await page.waitForTimeout(10000); 
  ...
  console.log("--Life press interface button 'Datos' to go back--"); //hay que volver a entrar y salir para que cargue esta grafica, no se por qué
  await page.click("body > main > main > ul > li:nth-child(2) > a"); 

  console.log("--Life press analytics type bubble again => analytics 2 view again--");
  await page.click("body > main > main > div.nav.svelte-1xdzfq5 > ul > li:nth-child(3) > a"); 
  await page.waitForTimeout(10000); 
  ...
  console.log("--Life press analytics type area => analytics 3 view--");
  await page.click("body > main > main > div.nav.svelte-1xdzfq5 > ul > li:nth-child(4) > a"); 
  await page.waitForTimeout(15000); 
  await page.screenshot({ path: screenshotPath + (counter++) +'_LIFE_analytics3_0.png' });

  console.log("--Life press interface button 'Datos' to go back--");
  await page.click("body > main > main > ul > li:nth-child(2) > a"); 
    

  console.log("Life insert new stat.....");
  ...
  await page.keyboard.type("taiwan");
    ...
    console.log("--interface press back to home button => home--");
    await page.click("body > main > main > div.nav.svelte-1xdzfq5 > ul > li:nth-child(1) > a"); //pagina principal
